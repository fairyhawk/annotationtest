...
/**
 * 
 * @ClassName com.t2.ClassPathXMLApplicationContext
 * @description
 * @author : qinggang.liu bis@foxmail.com
 * @Create Date : 2014-7-19 下午5:43:59
 */
public class ClassPathXMLLoad {

    List<BeanDefine> beanList = new ArrayList<BeanDefine>();//只存类的id和路径
    Map<String, Object> sigletions = new HashMap<String, Object>();//存储真正的类的实例

    public ClassPathXMLLoad(String fileName) {
        // 读取配置文件中管理的bean
    ...
    /**
     * 注解处理器 如果注解ZxfResource配置了name属性，则根据name所指定的名称获取要注入的实例引用，如果注解ZxfResource
